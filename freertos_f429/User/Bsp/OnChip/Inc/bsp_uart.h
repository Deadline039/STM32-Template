...
/* 未启用DMA可忽略 */
#define UARTx_DMA_TX_CLK_ENABLE() __HAL_RCC_DMA2_CLK_ENABLE()
#define UARTx_DMA_TX_STREAM       DMA2_Stream7
#define UARTx_DMA_TX_CHANNEL      DMA_CHANNEL_4
#define UARTx_DMA_TX_IRQn         DMA2_Stream7_IRQn
#define UARTx_DMA_TX_IRQHandler   DMA2_Stream7_IRQHandler

#define UARTx_DMA_RX_CLK_ENABLE() __HAL_RCC_DMA2_CLK_ENABLE()
#define UARTx_DMA_RX_STREAM       DMA2_Stream5
#define UARTx_DMA_RX_CHANNEL      DMA_CHANNEL_4
#define UARTx_DMA_RX_IRQn         DMA2_Stream5_IRQn
#define UARTx_DMA_RX_IRQHandler   DMA2_Stream5_IRQHandler
